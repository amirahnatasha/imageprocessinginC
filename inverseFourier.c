...
void InverseFourierTransformImage(unsigned char (*Red2)[MAXS], unsigned char (*Green2)[MAXS], unsigned char (*Blue2)[MAXS], long Width, long Height, char *filename)
{
    long i, j, u, v;
    double Hue = 0.0, Saturation = 0.0, Lightness = 0.0;
    float real, imag;
...
int main(void)
{
    ...
    InverseFourierTransformImage(Red2, Green2, Blue2, Width, Height, "fourier.txt");
    WriteImage("photo_inverseFourier.ppm", Red2, Green2, Blue2, Width, Height);
